...
const Credit = () => {
    ...
    return (
      ...
      <p className={`text-black text-sm opacity-70 transition-all duration-300 ease-in-out ${expanded ? "line-clamp-none" : "line-clamp-1"}`}>
        Yuu Yenn Property - “เพราะบ้าน...คือมากกว่าหลังคาและผนัง”
        มันคือจุดเริ่มต้นของชีวิตใหม่ ความฝันของครอบครัว พื้นที่เล็ก ๆ ที่คุณสร้างเรื่องราวขึ้นมาเองในทุกวัน 
        ไม่ว่าคุณจะเพิ่งเริ่มทำงาน กำลังสร้างครอบครัว หรือมองหาที่พักที่สะท้อนตัวตนของคุณ—เราพร้อมอยู่ข้างคุณ

        ที่ Yuu Yenn Property เราไม่ได้เป็นแค่เว็บขายบ้าน แต่เราอยากเป็นเพื่อนร่วมทางของคุณในการค้นหาสถานที่ที่เรียกว่า “บ้าน”
        เราออกแบบแพลตฟอร์มให้ใช้งานง่าย ตอบโจทย์ทุกไลฟ์สไตล์ ทั้งคอนโดในเมืองสำหรับชีวิตที่เร่งรีบ บ้านชานเมืองที่เต็มไปด้วยต้นไม้ 
        หรือบ้านมือสองราคาดีที่คุณแต่งเติมได้เองในแบบที่คุณเป็น

        เรามีระบบค้นหาที่ฉลาด แสดงผลเรียลไทม์ ฟิลเตอร์ครบ และแผนที่เข้าใจง่าย—เพราะเราเข้าใจว่าคุณไม่มีเวลาให้กับความวุ่นวาย
        เรายังมีทีมแชตให้คำปรึกษาแบบ real-human ไม่ใช่แค่บอท
        เรามีรีวิวบ้านจริงจากผู้ซื้อจริง และที่สำคัญคือ ไม่มีค่าธรรมเนียมแฝง ไม่มีนายหน้าแอบแฝง

        ในวันที่คุณพร้อม…แค่เปิดมือถือ แล้วมาเริ่มการเดินทางครั้งสำคัญของชีวิตกับเรา
        บ้านในฝันของคุณ ไม่ควรเป็นแค่ความฝัน
      </p>
