          ...
          <CardContent className="py-8 px-6 space-y-6">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="number" placeholder="เช่น 2500000" {...field} value={field.value ?? ""} onChange={(e) => handleFloatChange(e, field)} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="number" placeholder="เช่น 250000" {...field} value={field.value ?? ""} onChange={(e) => handleFloatChange(e, field)} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                   ...
                   <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="number" placeholder="เช่น 3.5" {...field} value={field.value ?? ""} onChange={(e) => handleFloatChange(e, field)} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="number" placeholder="เช่น 15000" {...field} value={field.value ?? ""} onChange={(e) => handleFloatChange(e, field)} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                   ...
                   <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="number" placeholder="เช่น 30000" {...field} value={field.value ?? ""} onChange={(e) => handleFloatChange(e, field)} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="เช่น ค่าส่วนกลาง 500 บาท/เดือน" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div className="flex justify-between pt-4">
                <Button type="button" variant="outline" onClick={() => navigate("/seller/post-for-sale/detail")}>
                  ย้อนกลับ
                </Button>
