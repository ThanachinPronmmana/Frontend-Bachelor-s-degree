    ...
    <div className="relative min-h-screen bg-[#2C3E50] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 bg-white bg-opacity-90 p-8 rounded-md w-[400px] shadow-lg">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-800">Yuu Yenn Property</h2>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="text-sm text-gray-700">Real Estate Agent License Number (Optional)</label>
            <input
              type="text"
              name="licenseNumber"
