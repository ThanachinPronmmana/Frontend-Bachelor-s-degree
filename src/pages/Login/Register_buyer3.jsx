    ...
    <div className="min-h-screen bg-[#2C3E50] flex items-center justify-center">
      <div className="relative bg-white w-[600px] rounded-md shadow-lg flex flex-col items-center py-10 px-8">
        ...
        <form onSubmit={handleSubmit} className="w-full grid grid-cols-2 gap-6">
          {/* Lifestyle Habits */}
          <div>
            <label className="block mb-2 font-medium text-sm">Lifestyle Habits</label>
            {["Work from Home", "Have Pets", "Need a Home Office", "Like Gardening"].map(
              (habit) => (
          ...
          {/* Accessibility Needs */}
          <div>
            <label className="block mb-2 font-medium text-sm">Health & Accessibility Needs</label>
            {["No stairs", "Wheelchair-friendly bathroom", "Quiet neighborhood"].map((need) => (
          ...
          <div className="col-span-2">
            <label className="block mb-2 font-medium text-sm">Special Requirements</label>
            <input
              type="text"
              placeholder="..."
          ...
          <div className="col-span-2 flex justify-between mt-6">
            ...
            <Link to="/">
            <button type="submit" className="bg-[#2C3E50] text-white px-6 py-2 rounded hover:bg-[#1a252f]">
              Submit
            </button>
            </Link>
          </div>
